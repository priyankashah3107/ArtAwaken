...
//        className='w-[122px] h-[20px] md:w-[274px] md:h-[45px]'
//       />
...
const MainNav = () => {
  ...
  return (
    <nav className="flex flex-row items-center  justify-between p-8 pl-4 md:pl-8  lg:pl-20 lg:p-10 ">
      ...
      <Image src={"/logo.png"} alt='logo' width={100} height={20} 
       className='w-[122px] h-[20px] md:w-[274px] md:h-[45px] cursor-pointer'
      />
      
      <div className='flex flex-row  items-center gap-6 cursor-pointer '>
        <h3 className=' hidden lg:block text-[25px] font-normal  leading-[25px] '>Exibitions</h3>
        <h3 className='hidden lg:block text-[25px] font-normal  leading-[25px]'>Artist</h3>
        <Link href='/pages/signup' className='btnMain md:rounded-[30px] ml-[15px] md:w-[120px] md:h-[50px] md:text-[25px] md:leading-[25px]'
         onClick={signup}
        >Join us</Link>
        <svg width="32" height="30" viewBox="0 0 32 30" fill="none" xmlns="http://www.w3.org/2000/svg">
             <path
