...
const Signup = () => {
  ...
  useEffect(() => {
      if(user.email.length > 1 && user.username.length > 1 &&  user.fullname.length> 1 && user.password.length > 1 ) {
  ...
  <>
   ...
   <div className='flex-1 flex flex-col justify-center items-center text-black'>
          ...
          <label className='input input-bordered rounded flex items-center gap-2'>
					...
					<button className='btn  font-inter rounded-full btn-primary text-black signupBtn'>{
				...
				<div className='flex flex-col md:flex-row  gap-2 mt-4'>
				 ...
				 <button className='flex flex-row items-center justify-center gap-2 mt-4 p-3 bg-white text-black rounded-md font-inter'> <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 48 48">
